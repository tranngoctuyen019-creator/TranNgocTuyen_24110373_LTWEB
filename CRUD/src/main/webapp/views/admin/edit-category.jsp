    ...
    <div class="page-wrap">
        ...
        <div class="form-card">
            ...
            <form role="form" action="${editUrl}" method="post" enctype="multipart/form-data">
                <!-- Hidden ID để Controller biết đang sửa dòng nào -->
                ...
                <div class="form-group">
                    ...
                    <div class="current-image-box">
                        ...
                        <img class="img-responsive img-thumbnail" width="120px" src="${imgUrl}" alt="Current Image" onerror="this.src='https://via.placeholder.com/120x100?text=No+Image'" style="margin: 0 auto;">
                    </div>

                    <label style="text-transform:none; letter-spacing:0;">Chọn ảnh mới (nếu muốn thay đổi)</label>
