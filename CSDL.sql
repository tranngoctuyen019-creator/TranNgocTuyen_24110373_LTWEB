...
-- =========================================================
-- Khớp đúng với web.com.models.Category
-- =========================================================
...
-- =========================================================
-- Khớp đúng với web.com.models.Account
-- =========================================================
...
-- =========================================================
-- Khớp đúng với web.com.models.Product
-- =========================================================
...
-- =========================================================
-- DỮ LIỆU MẪU: Account
-- Lưu ý: password ở đây chỉ là chuỗi mẫu (plain text placeholder).
-- Hãy thay bằng hash thực tế do PasswordUtil.java sinh ra trước khi dùng thật.
-- =========================================================
INSERT INTO [Account] (username, password, email, full_name, active, otp_code, otp_expiry, created_at) VALUES
(N'admin', N'123456', N'admin@example.com', N'Quản trị viên', 1, NULL, NULL, GETDATE()),
(N'user01', N'123456', N'user01@example.com', N'Nguyễn Văn A', 1, NULL, NULL, GETDATE());
GO

-- =========================================================
-- DỮ LIỆU MẪU: Product (10 sản phẩm, ảnh đuôi .jpg, tham chiếu cate_id vừa tạo ở trên)
-- =========================================================
INSERT INTO [Product] 
