...
<div class="admin-sidebar">
	...
	<ul class="admin-nav">
		...
		<li><a href="<c:url value='/admin/category/list'/>" class="${fn:contains(uri, '/admin/category') ? 'active' : ''}">Quản lý danh mục</a></li>
	...
	<c:if test="${not empty categories}">
		...
		<div class="admin-nav-heading">Lọc theo danh mục</div>
		<ul class="admin-nav">
			<li>
	...
	<div class="admin-sidebar-bottom">
		<a href="<c:url value='/admin/home'/>">Về trang chủ</a>
